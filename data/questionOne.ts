...
> Your main function must return a single number of the maximum number of steps you can take.
Nothing else.
> Console.Log Statements wont be shown at all!.
...
.664.598..`,
  ...
  {
    hidden: true,
    case: `.........232.633.......................803..........................361................192............539.................973.221...340.....
...
let verificationHandler = (fn: any) => {
  // fn is the callback that user's code is passed into
  let testCaseStatus: TestCaseStatus[] = [];

  for (const testcase of testCases) {
    try {
      let result = fn(testcase.case);
      let stat =
        String(result) === String(testcase.answer)
          ? Status.SUCCESS
          : Status.BUG;
      ...
      console.log("function handler function error");
      testCaseStatus.push({
        status: Status.ERROR,
        out: null,
        err: String(error),
...
const dummyCode = `
//DON'T WRITE ANYTHING HERE FUNCTION VARIABLE NOTHING

function main(map) {
    // Write The Code Here
    // map is the testcase input in string format
    // return the final number answer for checking
}

// write custom functions and variables here
// so that they can be used in the main function
`;
